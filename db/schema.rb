...
ActiveRecord::Schema.define(version: 20_201_001_023_328) do
  ...
  create_table 'reactions', force: :cascade do |t|
    ...
    t.index %w[user_id reaction_refs_id], name: 'index_reactions_on_user_id_and_reaction_refs_id', unique: true
